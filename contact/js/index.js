...
$('.animate_colos1, .animate_colos2').css({ transform: 'rotate(' + theta + 'rad)' });
$('.animate_colos3, .animate_colos6').css({ transform: 'rotate(-' + theta + 'rad)' });
$('.animate_colos4, .animate_colos5').css({ transform: 'rotate(-' + theta + 'rad)' });
$('.animate_colos7, .animate_colos9').css({ transform: 'rotate(-' + theta + 'rad)' });
$('.animate_colos10, .animate_colos8').css({ transform: 'rotate(-' + theta + 'rad)' });
...
$('.animate_colos17, .animate_colos19').css({ transform: 'rotate(-' + theta + 'rad)' });
